...
extension GrocerListViewController{
...
extension GrocerListViewController{
    ...
    func update_label_budget() {
        ...
        label_budget.text = alertTitle + total.description + " " +  "taka " + " " // unitOfMoney!
    }
    ...
    func update_label_money_spent() {
        ...
        label_money_spent.text = alertTitle + total.description + " " + "taka" + " "
    }//unitOfMoney!
    ...
    func getItemString(item : Item) -> String{
        ...
        if item.realPrice < 0.1 {
            ...
            realPriceString = item.realPrice.description + " taka "   + " "
        ...
        +   alertTitle2 + item.estimatedAmount.description + " " + item.unit + alertTitle3 + item.estimatedPrice.description + " " +  "taka" + " " +  alertTitle4 + realAmountString + " " + alertTitle5  + realPriceString // unitOfMoney!
